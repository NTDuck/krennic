...
def normalize_z_score(df: pd.DataFrame, column: str, new_column: Optional[str] = None) -> pd.DataFrame:
...
def normalize_min_max(df: pd.DataFrame, column: str, new_column: Optional[str] = None) -> pd.DataFrame:
    new_column = new_column or column
...
def normalize_abs_max(df: pd.DataFrame, column: str, new_column: Optional[str] = None) -> pd.DataFrame:
    new_column = new_column or column
...
def normalize_robust(df: pd.DataFrame, column: str, new_column: Optional[str] = None) -> pd.DataFrame:
    new_column = new_column or column
